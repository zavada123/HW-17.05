...
if (myage > 15 && myage < 17) {
    ...
    skills = 'Работал системным администратором и небыло мыслы переходить в программисты';
} else if (myage >= 20 && myage <= 21) {
    skills = 'Познакомился с Виталиком, он меня ввел в курс дела и первое время работал на него';
} else if (myage < 23) {
